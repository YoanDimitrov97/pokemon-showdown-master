...
export const Moves: { [moveid: string]: MoveData } = {
	...
	sharkdarts: {
		...
		category: "Physical",
		name: "Shark Darts",
		shortDesc: "Hits thrice. Doubles: Tries to hit each foe once.",
		pp: 10,
		priority: 0,
		flags: { protect: 1, mirror: 1, noparentalbond: 1 },
		multihit: 3,
	...
	firefist: {
		...
		category: "Special",
		name: "Fire Fist",
		shortDesc: "Uses higher of ATK or SPATK. Destroys Screens.",
		pp: 10,
		priority: 0,
	...
	hellhound: {
		...
		category: "Special",
		name: "Hell Hound",
		shortDesc: "40% chance to burn adjacent Pokemon.",
		pp: 10,
		priority: 0,
		flags: { protect: 1, mirror: 1 },
		secondary: {
